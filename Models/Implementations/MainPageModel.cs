        ...
        public MainPageModel()
        {
            Images = new AdvancedObservableCollection<IPhotoModel>
            {
                new PhotoModel
                {
                    ...
                    RedundantPhotos =
                    {
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard2.jpg", Similarity = 70},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 20},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 40},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 80},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 10},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 30},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 50},
                        new RedundantPhotoModel {TmpImagePath = "ms-appx:///Assets/leopard1.jpg", Similarity = 90}
                    },
